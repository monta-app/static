...
Monta's Information Security Policy has been drafted based on the principles of ISO-27001 and **the SOC 2 Trust Services Criteria, two internationally-recognized frameworks for safeguarding information. 

Aligning with both standards supports our goals of: improved value proposition to enterprise customers, protecting stakeholders, maturing our tech stack and obtaining additional brand value.
...
This Policy applies to all directors, officers and employees of Monta, as well as third-party contractors and agents of Monta that have access to information or Monta Systems owned or leased by Monta (collectively “Authorized Users”).

# Policy

Monta requires all Authorized Users to exercise a duty of care in relation to the operation and use of the Monta Systems.

## Acceptable use

Use of the Monta’s Systems by Authorized Users will be lawful, honest and decent. Authorized Users are obliged by acceptable use principles and policies as part of their contracts with Monta.
...
Monta accept that employees are working from home or in other locations outside the office, however, to retain adequate information security this is regulated by the IT Policy.

## Cyber Security

Monta is addressing the threat of cyber-attacks both through our technical protection setup and through behavioral and technical guidelines for all Authorized Users in the IT Policy and as described in our Cyber Security Policy.
...
These policies can be shared on a private and confidential basis with third parties having a legitimate interest upon their request.
...
All Authorized Users are required to adhere to this Policy. Failure to comply may result in different disciplinary actions depending on the severity of the breach set out in the Information Security Handbook.
...
The Policy shall be reviewed on an annual basis by the Information Security Board. Further, it shall be reviewed, and eventual edits shall be approved, by Monta Management once per year.
