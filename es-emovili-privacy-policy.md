...
Original traducido con ChatGPT de 
...
Cuando hablamos de nuestro "Sitio web", nos referimos a  y otros sitios y aplicaciones de nuestra propiedad y operación. Cuando nos referimos a "portales de usuario" y "aplicaciones móviles", nos referimos a nuestro producto "Emovili Fast".

Si tiene alguna pregunta sobre esta Política de Privacidad o desea ejercer sus derechos como sujeto de datos de acuerdo con el Capítulo III del GDPR y según la sección 7 de esta Política de Privacidad, comuníquese con Emovili Fast en .

Categorías de datos personales, propósito y base legal 2.1 Visitantes de nuestro Sitio web, portales de usuario y/o aplicaciones móviles, y receptores de boletines
...
Si deseas ejercer alguno de los derechos mencionados anteriormente o si deseas retirar un consentimiento anterior, no dudes en ponerte en contacto con nosotros en .

Preguntas o quejas

Si tienes alguna pregunta relacionada con esta Política de privacidad, deseas ejercer tus derechos como se mencionó anteriormente o no estás de acuerdo con la forma en que Emovili Fast procesa tus datos personales, puedes ponerte en contacto con Emovili Fast en .
